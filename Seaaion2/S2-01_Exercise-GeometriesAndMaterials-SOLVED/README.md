...
*/
var texture = new THREE.TextureLoader().load('textures/306.jpg');
var material3 = new THREE.MeshBasicMaterial({map :texture });
var geometry = new THREE.ConeBufferGeometry( 88, 20, 32 );
...
varmaterial = new THREE.MeshLambertMaterial();
...
* this code is related to the scene which contains 13 different meshes, I loaded wooden texture to one of them, and did some color changes on other meshes. This scene also has different geometries.
