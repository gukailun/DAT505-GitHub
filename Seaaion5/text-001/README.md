...
* this code showed how the mesh changes on the x y axis and defined the random position and rotation direction of the meshs.So it ends up looking like a struggling octopus.
